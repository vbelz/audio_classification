...
feat_input=np.load("/Users/vincentbelz/Documents/Data/audio_classification/VGG_features/VGG_feat_speconly.npy")
...
modeltop.add(Dense(1024, activation='sigmoid', input_dim=8192))
