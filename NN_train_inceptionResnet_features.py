...
feat_input=np.load("/Users/vincentbelz/Documents/Data/audio_classification/InceptionResnet_features/InceptionResnet_feat.npy")
...
modeltop.add(Dense(1024, activation='sigmoid', input_dim=38400))
#modeltop.add(Dense(4096, activation='sigmoid'))
modeltop.add(Dropout(0.1))
modeltop.add(Dense(256, activation='sigmoid'))
modeltop.add(Dropout(0.2))
modeltop.add(Dense(64, activation='sigmoid'))
...
for j, (train_idx, val_idx) in enumerate(folds):
    ...
    modeltop.fit(x_train_cv, y_train_cv, epochs=1, batch_size=32, shuffle=True, verbose=1, validation_data=(x_valid_cv, y_valid_cv))
